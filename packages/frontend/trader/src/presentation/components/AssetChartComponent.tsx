...
import { AssetDaily } from '@/core/domain/models'
import { fetcher } from '@/utils/BrokerClosed'
import { ChartComponent, ChartComponentRef } from '@/components/ChartComponents'
